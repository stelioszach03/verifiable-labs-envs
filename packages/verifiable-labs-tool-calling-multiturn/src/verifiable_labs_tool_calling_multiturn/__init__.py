"""Verifiable Labs env wrapper: tool-calling-multiturn.

Multi-turn procedural tool-calling RL environment with
verifier-feedback rollouts and per-extra-turn penalty. Thin
re-export over ``verifiable_labs_envs.envs``.
"""
from verifiable_labs_envs.envs.tool_calling_multiturn import (
    load_environment as _load_environment_base,
)

ENV_NAME = "tool-calling-multiturn"
__version__ = "0.1.0"
