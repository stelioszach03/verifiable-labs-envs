# verifiable-labs-sparse-fourier
...
- A verifiers-compatible entry point: ``verifiers.environments → sparse-fourier-recovery``.
- A direct factory: ``from verifiable_labs_sparse_fourier import load_environment``.
