"""__ENV_ID__ — Verifiable Labs tool-calling RL environment.

Domain: __DOMAIN__.

Scaffolded from ``templates/tool-calling/`` via
...
# Default: 64-bit seed × 10 templates × ~1e6 combinations ≈ 1.8e23.
