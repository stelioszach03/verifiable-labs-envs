...
Prime Intellect Hub wrapper around ``verifiable_labs_envs.envs.phase_retrieval``.
...
from verifiable_labs_envs.envs.phase_retrieval import load_environment as _le


def load_environment(**kwargs: Any):
    """Factory for the ``phase-retrieval`` environment.
