...
Prime Intellect Hub wrapper around ``verifiable_labs_envs.envs.super_resolution``.
...
from verifiable_labs_envs.envs.super_resolution import load_environment as _le


def load_environment(**kwargs: Any):
    """Factory for the ``super-resolution-div2k-x4`` environment.
