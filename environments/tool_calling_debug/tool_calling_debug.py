"""Debug-loop tool-calling — narrate-act-observe scaffolding.

Prime Intellect Hub wrapper around ``verifiable_labs_envs.envs.tool_calling_debug``.
...
from verifiable_labs_envs.envs.tool_calling_debug import load_environment as _le
