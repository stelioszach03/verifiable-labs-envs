...
Prime Intellect Hub wrapper around ``verifiable_labs_envs.envs.sparse_fourier_multiturn``.
...
from verifiable_labs_envs.envs.sparse_fourier_multiturn import load_environment as _le


def load_environment(**kwargs: Any):
    """Factory for the ``sparse-fourier-recovery-multiturn`` environment.
