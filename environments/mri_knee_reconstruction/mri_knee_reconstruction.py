...
Prime Intellect Hub wrapper around ``verifiable_labs_envs.envs.mri_knee``.
...
from verifiable_labs_envs.envs.mri_knee import load_environment as _le


def load_environment(**kwargs: Any):
    """Factory for the ``mri-knee-reconstruction`` environment.
