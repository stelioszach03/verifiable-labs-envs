...
Prime Intellect Hub wrapper around ``verifiable_labs_envs.envs.lodopab_ct_multiturn``.
...
from verifiable_labs_envs.envs.lodopab_ct_multiturn import load_environment as _le


def load_environment(**kwargs: Any):
    """Factory for the ``lodopab-ct-simplified-multiturn`` environment.
