...
\citep{tropp2007signal, donoho2006compressed, candes2006near}, FBP,
zero-filled inverse FFT,
Gerchberg--Saxton
...
solver must compose ISTA \citep{daubechies2004iterative}. An earlier v0.1 design bundled an
...
(env,~model) cell. Paired-bootstrap significance testing uses 10k
resamples.
...
\url{github.com/verifiablelabs/verifiable-labs-envs}; envs (flagship
page; full ten-env list mirrored on the leaderboard below):
\url{app.primeintellect.ai/dashboard/environments/stelioszach/sparse-fourier-recovery};
leaderboard:
\url{huggingface.co/spaces/verifiablelabs/scientific-rl-benchmark}.
