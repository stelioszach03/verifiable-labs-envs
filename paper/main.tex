...
(env,~model) cell. Total LLM API spend across all four
paper-final benchmark CSVs:
\$5.49. Paired-bootstrap significance testing uses 10k resamples.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.62\linewidth]{figures/fig3_multiturn.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.62\linewidth]{figures/fig5_tools.pdf}
