#!/usr/bin/env bash
# scripts/experiments/run_E5b.sh
#
# E5b — Dataset scaling point 2: same as E5a but with 15K samples.
# Pairs with E5a (5K) to chart the dataset-size scaling curve.
#
...
export EXPERIMENT_ID="E5b"
export EXPERIMENT_DESCRIPTION="E5b — Dataset scaling (15K samples)"
export DATASET_PATH="${VLABS_REPO_ROOT}/reports/reward_distillation/v0.0.1_train_15k.jsonl"
