...
REQUIRED_SECRETS=(
  # Names mirror the Pydantic Settings class in
  # services/api/src/vlabs_api/config.py and the Phase 1+2 deploy
  # provisioner output (see reports/deploy/SECRETS_GAP_REPORT.md).
  "DATABASE_URL"
